...
The output is a ranked list of candidate shared core sequences with approximate phage and host coordinates, strand, locus label, core length, seed support, match model, stem evidence when relevant, and a heuristic prediction score.
...
The original version was most useful for tyrosine-integrase-like searches because it emphasized longer exact shared cores near tRNA/tmRNA/rRNA loci. This patched version adds two serine-aware improvements:
